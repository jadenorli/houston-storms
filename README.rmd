...
1.  Data Management
    -   Wrangling and tidying data using [@tidyverse], [@here], and [@janitor] to ensure clean, reproducible workflows
...
2.  Geospatial Analysis
    -   Manipulating spatial data with [@terra] and [@sf], including advanced spatial operations such as intersections, raster manipulation, and spatial weighting

    -   Creating dynamic, interactive visualizations using [@tmap] to explore and communicate geospatial data insights
