...
standard_kable(properties_summary_tibble, 
               col_names, 
...
#generate the kable from the tibble output
standard_kable(verify_properties_tibble, 
               col_names_v, 
               caption = "Geometric Properties Verification")
...
animation <- tmap_animation(list(NL_02072021_crop_map, 
                                 NL_02162021_crop_map, 
                                 blackout_map),
...
standard_kable(combined_table, 
               col_names_s, 
               caption = "Blackout Status Summary for Homes in Houston")
